...
var IHadis = function () {
    ...
    var handleHadithTools = function() {
        ...
        $(tools).live('click', function(){
            ...
            var content = box.find(".had > p.narrated-by").text() + " " + box.find(".had > p.hadith-des").eq(1).text();
            var windowFeatures = 'width=626,height=436,menubar=no,toolbar=no,resizable=yes,scrollbars=yes';

           switch (action) {
               case 'report'      :
                   $('#report-hadith #comments').val("Assalamu 'Alaikum, \n\nI'd like to report this hadith: "+ permalink + ". \n");
                   $('#report-modal').modal({'backdrop': true, 'keyboard': true, 'show': true}); break;
